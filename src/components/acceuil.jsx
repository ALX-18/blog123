                    ...
                    <div className="container px-4 md:px-6">
                        ...
                        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                            {recentInterviews.length > 0 ? recentInterviews.map((interview, index) => (
                                <Card key={interview.id} className="overflow-hidden group hover:shadow-lg transition-shadow border-0 shadow-sm rounded-xl">
                                ...
                                <div className="col-span-3 text-center text-muted-foreground">Aucune interview récente</div>
                            )}
                        </div>
                    </div>
                </section>
                        ...
                        <div className="relative overflow-hidden rounded-2xl bg-[#E03C31]">
                            ...
                            <div className="grid md:grid-cols-2 gap-6 p-6 md:p-10">
                                {featuredArticle ? (
                                    ...
                                    <div className="col-span-2 flex justify-center items-center min-h-[200px] text-white/80">Aucun article à la une</div>
                                )}
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="container px-4 md:px-6">
                        ...
                        <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
                            {recentArticles.filter(a => a.id !== (featuredArticle && featuredArticle.id)).map((article, index) => (
                                <Card key={article.id} className="overflow-hidden hover:shadow-lg transition-shadow border-0 shadow-sm rounded-xl">
                                    ...
                                    <CardContent className="pt-4">
                                        ...
                                        <div className="flex justify-between items-center">
                                            <span className="text-xs text-muted-foreground">{article.createdAt && article.createdAt.toDate ? article.createdAt.toDate().toLocaleDateString("fr-FR") : "Date inconnue"}</span>
