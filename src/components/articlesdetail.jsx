      ...
      <main className="flex-1 py-12">
        <section className="container px-4 md:px-6">
          <article className="max-w-3xl mx-auto bg-white rounded-lg shadow-lg p-8">
            {/* Title */}
            <h1 className="text-4xl font-bold text-[#E03C31] mb-4">
            ...
            <p className="text-gray-600 text-sm mb-4">Par: {article.author}</p>
            ...
            {/* Article Content avec préservation des espaces et retours à la ligne */}
